...
export type CheckpointEnablementScope = { "scope": "global" } | { "scope": "project", project_id: string, };

export type ProjectCheckpointOverride = { projectId: string, enabled: boolean, };
 ...
 */
projectOverrides: Array<ProjectCheckpointOverride>, };
 ...
 */
enabled?: boolean, } | { "type": "get_checkpoint_settings" };
