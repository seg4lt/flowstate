...
impl OrchestrationService {
    ...
    pub fn create_session(&self, provider: ProviderKind, title: Option<String>) -> SessionDetail {
    ...
    pub fn start_turn(&self, session: &mut SessionDetail, input: String) -> TurnRecord {
